...
class Lang
{
	...
	public static function available_languages()
	{
		...
		{
			// Set available languages
			Lang::$available_languages = array_keys(Kohana::$config->load('lang.languages'));
		}
	...
	public static function config()
	{
		if ( ! Lang::$config)
		{
			Lang::$config  = Kohana::$config->load('lang');
			Lang::$cookie  = Lang::$config->cookie;
			Lang::$default = Lang::$config->default;
		}
	...
	public static function i18ncode($language = NULL)
	{
		...
		return Kohana::$config->load('lang.languages.'.$language.'.i18n_code');
	}
}
